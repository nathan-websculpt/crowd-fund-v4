...
export class CrowdFundTestFifteen__fundRunValuesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class CrowdFundTestFifteen extends ethereum.SmartContract {
  static bind(address: Address): CrowdFundTestFifteen {
    return new CrowdFundTestFifteen("CrowdFundTestFifteen", address);
  }
  ...
  fundRunValues(param0: i32): CrowdFundTestFifteen__fundRunValuesResult {
    let result = super.call(
      "fundRunValues",
    ...
    return new CrowdFundTestFifteen__fundRunValuesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_fundRunValues(
    param0: i32
  ): ethereum.CallResult<CrowdFundTestFifteen__fundRunValuesResult> {
    let result = super.tryCall(
      "fundRunValues",
      "fundRunValues(uint16):(uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(param0))]
    ...
    return ethereum.CallResult.fromValue(
      new CrowdFundTestFifteen__fundRunValuesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
