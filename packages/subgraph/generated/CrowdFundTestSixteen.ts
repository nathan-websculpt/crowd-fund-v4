...
export class CrowdFundTestSixteen__fundRunValuesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class CrowdFundTestSixteen extends ethereum.SmartContract {
  static bind(address: Address): CrowdFundTestSixteen {
    return new CrowdFundTestSixteen("CrowdFundTestSixteen", address);
  }
  ...
  fundRunValues(param0: i32): CrowdFundTestSixteen__fundRunValuesResult {
    let result = super.call(
      "fundRunValues",
    ...
    return new CrowdFundTestSixteen__fundRunValuesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_fundRunValues(
    param0: i32
  ): ethereum.CallResult<CrowdFundTestSixteen__fundRunValuesResult> {
    let result = super.tryCall(
      "fundRunValues",
      "fundRunValues(uint16):(uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(BigInt.fromI32(param0))]
    ...
    return ethereum.CallResult.fromValue(
      new CrowdFundTestSixteen__fundRunValuesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
