...
export class SocialProposal extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save SocialProposal entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type SocialProposal must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("SocialProposal", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): SocialProposal | null {
    return changetype<SocialProposal | null>(
      store.get_in_block("SocialProposal", id.toHexString())
    );
  }

  static load(id: Bytes): SocialProposal | null {
    return changetype<SocialProposal | null>(
      store.get("SocialProposal", id.toHexString())
    );
  }
  ...
  get socialProposalId(): i32 {
    let value = this.get("socialProposalId");
    if (!value || value.kind == ValueKind.NULL) {
      return 0;
    } else {
      return value.toI32();
  ...
  set socialProposalId(value: i32) {
    this.set("socialProposalId", Value.fromI32(value));
  }
  ...
  set postText(value: string) {
    this.set("postText", Value.fromString(value));
  }
  ...
  get signatures(): SocialProposalSignatureLoader {
    return new SocialProposalSignatureLoader(
      "SocialProposal",
      this.get("id")!
        .toBytes()
        .toHexString(),
...
export class SocialProposalSignature extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    ...
    assert(
      id != null,
      "Cannot save SocialProposalSignature entity without an ID"
    );
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type SocialProposalSignature must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("SocialProposalSignature", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): SocialProposalSignature | null {
    return changetype<SocialProposalSignature | null>(
      store.get_in_block("SocialProposalSignature", id.toHexString())
    );
  }

  static load(id: Bytes): SocialProposalSignature | null {
    return changetype<SocialProposalSignature | null>(
      store.get("SocialProposalSignature", id.toHexString())
    );
  }
  ...
  get socialProposal(): Bytes | null {
    let value = this.get("socialProposal");
    if (!value || value.kind == ValueKind.NULL) {
      return null;
    } else {
      return value.toBytes();
  ...
  set socialProposal(value: Bytes | null) {
    if (!value) {
      this.unset("socialProposal");
    } else {
      this.set("socialProposal", Value.fromBytes(<Bytes>value));
    }
  }
}
...
export class SocialProposalRevoke extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save SocialProposalRevoke entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type SocialProposalRevoke must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("SocialProposalRevoke", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): SocialProposalRevoke | null {
    return changetype<SocialProposalRevoke | null>(
      store.get_in_block("SocialProposalRevoke", id.toHexString())
    );
  }

  static load(id: Bytes): SocialProposalRevoke | null {
    return changetype<SocialProposalRevoke | null>(
      store.get("SocialProposalRevoke", id.toHexString())
    );
  }
...
export class SocialPost extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save SocialPost entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type SocialPost must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("SocialPost", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): SocialPost | null {
    return changetype<SocialPost | null>(
      store.get_in_block("SocialPost", id.toHexString())
    );
  }

  static load(id: Bytes): SocialPost | null {
    return changetype<SocialPost | null>(
      store.get("SocialPost", id.toHexString())
    );
  }
...
export class SocialProposalSignatureLoader extends Entity {
  _entity: string;
  _field: string;
  _id: string;
